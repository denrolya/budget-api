...
#[ApiResource(
    ...
    operations: [
        ...
        new Put(description: 'Update a transaction. Returns 204 with no body.', requirements: ['id' => '\d+'], status: 204, output: false, security: 'object.getOwner() == user'),
        new Delete(description: 'Delete a transaction and reverse its effect on the account balance.', requirements: ['id' => '\d+'], security: 'object.getOwner() == user'),
    ],
